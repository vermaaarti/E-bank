...
?>
	...
	<div class="container">
        ...
        <br><br><br>
        <label class="text-light"><b>Transfer To:</b></label>
        <select name="to" class="form-control bg-dark border-light text-light" required>
        ...
        <br>
        <br>
            <label class="text-light"><b>Amount:</b></label>
            <input type="number" class="form-control bg-dark border-light text-light" name="amount" required autocomplete="off">   
            <br><br>
