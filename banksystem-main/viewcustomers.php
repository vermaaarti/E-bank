...
<div class="container">
        <h2 class="text-center pt-5 text-light mt-5">View Customers</h2>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead class="text-light">
                            ...
                            <th scope="col" class="text-center py-2 text-light">Operation</th>
                            </tr>
                        </thead>
                        <tbody>
                <?php 
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn bg-light text-dark">Transfer</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
